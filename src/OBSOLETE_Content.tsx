...
// dies ist eine eigne komponent --> exportieren in separates file
// instanzieren wie komponente
const createTableHeader = (
  ...
  if (filteredTaskEntries.length === 0) {
    return <div className="contTable_NoEntries">Keine Todos gefunden.</div>;
  }
  return (
